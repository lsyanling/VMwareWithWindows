...
do
  ...
  for ((i=0;i<num_tries;i++))
	do
    # start a new screen
    screen -dmS ascr$i python3 main.py -j1 -u=$util -g0 -r$runs_per_screen -n=$i
...
do
  ...
  for ((i=0;i<num_tries;i++))
	do
    # start a new screen
    screen -dmS ascr$i python3 main.py -j1 -u=$util -g1 -r$runs_per_screen -n=$i
...
# for i in {50..90..10}
# do
#   screen -dmS ascrg0util_$i python3 main.py -j2 -u=$i -g0 -n=$num_tries
#   # wait until variable is reached
#   while (($numberrec >= $var))
#   do
#     sleep 1
...
# for i in {50..90..10}
# do
#   screen -dmS ascrg1util_$i python3 main.py -j2 -u=$i -g1 -n=$num_tries
#   # wait until variable is reached
#   while (($numberrec >= $var))
#   do
#     sleep 1
